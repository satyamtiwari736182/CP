...
insert into studies_1157(course,ccost,p_id) 
values  ('Oracle',5000,'C1'),
        ('Java',5000,'O2'),
        ('Advanced Java',5000,'O3');
        

insert into software_1157 
values  ('S1','CProject','C',5000,2000,5,'C4'),
...
where programmer_1157.p_id in ( select software_1157.p_id 
                                from software_1157
